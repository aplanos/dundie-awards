package com.ninjaone.dundieawards.activity.infraestructure.config;
...
@EnableJpaRepositories(basePackages = "com.ninjaone.dundieawards.activity.infraestructure.repository",
